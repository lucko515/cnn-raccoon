...
from cnn_raccoon.pytorch.utils import convert_to_grayscale
...
class SaliencyMap(Base):
    ...
    Credit: https://github.com/FrancescoSaverioZuppichini/A-journey-into-Convolutional-Neural-Network-visualization-
    """
