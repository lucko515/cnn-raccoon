...
from cnn_raccoon.pytorch.model_weights import Base
from cnn_raccoon.pytorch.utils import module2traced, tensor2cam


class GradCam(Base):
    def __init__(self, *args, **kwargs):
        """
        Credit to: https://github.com/FrancescoSaverioZuppichini/A-journey-into-Convolutional-Neural-Network-visualization-
